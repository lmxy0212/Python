...
class LinkedBinaryTree:
    ...
    def leaves_list(self):
        lst = []
        return self.leaves_helper(self.root)
        # return lst

    # def leaves_helper(self, curr_root,lst):
    #     if (curr_root is None):
    #         return
    #     else:
    #         if curr_root.left is None and curr_root.right is None:
    #             lst.append(curr_root.data)
    #         else:
    #             self.leaves_helper(curr_root.left,lst)
    #             self.leaves_helper(curr_root.right,lst)

    def leaves_helper(self, curr_root):
        if (curr_root is None):
            return []
        if curr_root.left is None and curr_root.right is None:
            return [curr_root.data]
        else:
            l = self.leaves_helper(curr_root.left)
            r = self.leaves_helper(curr_root.right)
            l.extend(r)
            print(r,l)
            return l
