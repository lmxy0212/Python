class BinarySearchTreeMap:
    ...
    def subtree_find(self, subtree_root, key, add=None):
        curr = subtree_root
    ...
    def __setitem__(self, key, value):
        node = self.subtree_find(self.root, key,"add")
        if (node is None):
    ...
    def subtree_delete(self, node, key):
        node_to_delete = self.subtree_find(node, key,"del")
    ...
    def get_ith_smallest_helper(self,curr,i):
        if curr.l_children == i-1:
            return curr.item.key
        elif curr.l_children < i:
            return self.get_ith_smallest_helper(curr.right, i - curr.l_children-1)
        else: #curr.l_children > i
            return self.get_ith_smallest_helper(curr.left, i)
...
def main():
    ...
    bst[9] = None
    bst[13] = None
    # print(bst.root.right.l_children)
    # print(bst.root.r_children)
    print(bst.get_ith_smallest(3))
    print(bst.get_ith_smallest(8))
